...
"map <C-i> :IndentLineToggle<CR>             " open or close indentLine
...
" function {
    ...
    func! SetTitle()         " define function SetTitle, auto insert file header
        ...
        if &filetype=='c'
            ...
            call append(line(".")+7, "  * @Brief        : brief")
            call append(line(".")+8, "  ********************************************************************************")
            call append(line(".")+9, "  */")
            call append(line(".")+10, "")
            ...
            call append(line(".")+25, "  * @param  : None")
            call append(line(".")+26, "  * @retval : None")
            call append(line(".")+27, "  */")
            ...
            call append(line(".")+35, "  */")
            call append(line(".")+36, "")
            call append(line(".")+37, "/************************** Coopyright (C) Jungleeee 2017 *******END OF FILE*******/")
        endif
        if expand("%:e")=='h'
            call setline(1, "/**")
            call append(line("."),   "  ********************************************************************************")
            ...
            call append(line(".")+16, "")
            call append(line(".")+17, "/* Exported typedef ------------------------------------------------------------*/")
